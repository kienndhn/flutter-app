              ...
              children: [
                _buildQuickActionCard(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Thêm mới')));
                  },
                ),
                _buildQuickActionCard(
                  icon: Icons.list,
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Danh sách')));
                  },
                ),
                _buildQuickActionCard(
                  icon: Icons.settings,
  ...
  Widget _buildRecentItemList(BuildContext context) {
    final recentItems = [
      ...
      },
      {
        ...
        'time': '5 giờ trước',
        'description':
            'Chi tiết về item 2 - Item này có nhiều thông tin thú vị',
      },
      {
        'title': 'Item 3',
